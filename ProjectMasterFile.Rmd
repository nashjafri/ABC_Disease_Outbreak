...
- Prior on the parameters: $ P(q) \sim $ Uniform[0,1]
- Similarity measure: $ d(D_{obs}, D^*) = \cfrac{1}{2}\left(\|D_1−D^∗(q_{c1},q_{h1}) \|_F + \|D_2−D^∗(q_{c2},q_{h2}) \|_F \right) $ 
- Tolerance $ \epsilon $
...
par(pty = "s")      # Set the aspect ratio to 1:1, ensuring the plot is square ("s")
