...
```{r}
# Returns 2 random values from the uniform prior distrubution on [0,1]
...
Below is code to save this locally.
...
print(paste("q_c is", influenza_a_q_c , "and q_h is" , influenza_a_q_h))
